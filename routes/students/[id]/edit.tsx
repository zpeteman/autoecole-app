...
export default async function EditStudent(req: Request, ctx: { params: { id: string } }) {
  const student = await Database.getStudent(ctx.params.id);
  ...
  return (
    <>
      <Head>
        <title>Auto École - Modifier l'étudiant</title>
      </Head>
      <Layout>
        <div class="py-6">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            <h1 class="text-2xl font-semibold text-gray-900">Modifier l'étudiant</h1>
          </div>
          <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            <div class="py-4">
